    ...
    <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          Empower your trading journey with AI-driven insights, real-time data, and smart recommendations — all in one place.
        </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: "Data Analysis",
                description: "Get deep insights from your data with advanced analytics and visualization tools.",
                icon: "📊"
              },
              {
                title: "24/7 Support",
                description: "Your AI agents work around the clock to ensure optimal performance and results.",
                icon: "🛡️"
              }
            ].map((feature, index) => (
              <div key={index} className="text-center p-6 bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
